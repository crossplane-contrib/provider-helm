...
RESOURCE="release.helm.m.crossplane.io/url-drift-namespaced"
...
SECRET=$(${KUBECTL} -n crossplane-system get secret -l "name=url-drift-namespaced,owner=helm" --sort-by=.metadata.creationTimestamp -o name | tail -n 1)
